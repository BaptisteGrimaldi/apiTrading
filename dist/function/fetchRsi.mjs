...
//     });
// }
export function fetchRsi(symbolAction) {
    return __awaiter(this, void 0, void 0, function* () {
        yield fetch(`https://api.twelvedata.com/rsi?symbol=${symbolAction}&interval=1day&time_period=14&apikey=b914fed0677e48cdaf1938b5be42956d`).then((res) => {
            return res.json();
        })
            .catch(() => {
            console.log('RSI non trouvé', symbolAction);
